...
{
  if (checkdim(col1, lig1, "methode distA, point 1") && checkdim(col2, lig2, "methode distA, point 2") && checkdim(col1 + w - 1, lig1 + h - 1, "methode distA, point 1bis") && checkdim(col2 + w - 1, lig2 + h - 1, "methode distA, point 2bis"))
  {
    double res = 0.0;
    int x, y;
    for (y = 0; y < h; y++)
